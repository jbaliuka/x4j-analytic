...
public class VerticalContainerHeigthEstimatorTest extends EstimatorTestFixture {

    @Before
    public void setup() {
        super.setup();
        estimator = new VerticalContainerHeigthEstimator(row);
    }
